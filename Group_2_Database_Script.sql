-- Group 2
-- Amya Camberos, Monak Gajjar, Lord Elgin Raguero, Matthew David Storm, Artem Mevshyi 

CREATE DATABASE IF NOT EXISTS animedb;
USE animedb;


-- Tables. Note: This was autogenerated with Prisma
...
-- Views
-- Returns a detailed list of shows within a users watchlist, including the anime info and genre info, as well as watchlist status
...
-- Returns a detailed list of information for anime shows, including anime info, genre name, and the average rating of that show
...
-- Adds a show to a users watchlist
...
-- Returns a list of all shows that have > min_episodes in a users watchlist
...
-- triggers
-- Dont allow years past the current year for inserts
...
-- Dont allow years past the current year for updates
